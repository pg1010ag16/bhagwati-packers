...
export default function GoogleSheetsConnect({
  ...
  return (
    <section className="card border-brand-teal/20 bg-gradient-to-br from-white to-brand-teal/[0.04]">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <div>
          <h2 className="section-title">
            Bhagwati Packers Job Database
          </h2>

          <p className="mt-1 text-sm text-slate-500">
            Jobs loaded automatically from Google Sheets
          </p>
        </div>
